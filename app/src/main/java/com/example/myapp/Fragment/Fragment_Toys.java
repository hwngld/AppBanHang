...
public class Fragment_Toys extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.list_toys);
        ...
        searchView = view.findViewById(R.id.SearchToys);
    ...
    private List<Product> ListData() {
        ...
        for(Product product: HomeActivity.productList){
            if (product.getType().equals("Do choi")){
                list.add(product);
            }
        }
        return list;
