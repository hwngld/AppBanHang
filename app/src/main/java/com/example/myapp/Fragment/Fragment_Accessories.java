...
public class Fragment_Accessories extends Fragment_Food {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.list_accessories);
        ...
        searchView = view.findViewById(R.id.SearchAccessories);
    ...
    private List<Product> ListData() {
        ...
        for(Product product: HomeActivity.productList){
            if (product.getType().equals("Phu kien")){
                list.add(product);
            }
        }
        return list;
