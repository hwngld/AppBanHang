...
public class Fragment_Cleaning extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.list_cleaning);
        ...
        searchView = view.findViewById(R.id.SearchCleaning);
    ...
    private List<Product> ListData() {
        ...
        for(Product product: HomeActivity.productList){
            if (product.getType().equals("Dung cu ve sinh")){
                list.add(product);
            }
        }
        return list;
